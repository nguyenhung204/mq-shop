...
import type { InventoryTransfer, Warehouse } from "@/lib/api/inventory";
import {
  useApproveTransfer,
  useCancelTransfer,
  useReceiveTransfer,
...
function warehouseInfo(transfer: InventoryTransfer, direction: "from" | "to") {
  ...
  const type = w.warehouseType === "PLATFORM" ? " (Platform)" : " (Shop)";
        ...
        <div className="mq-card p-5 space-y-3">
          <div className="flex flex-wrap gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-xs font-medium">{warehouseInfo(transfer, "from")}</p>
            </div>
            <div>
              <span className="text-xs text-mq-text-muted">{t("seller.transfers.toWarehouse")}</span>
              <p className="text-xs font-medium">{warehouseInfo(transfer, "to")}</p>
            </div>
            <div>
