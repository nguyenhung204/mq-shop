                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 flex flex-col gap-1.5">
                          ...
                          {regionCode &&
                            ...
                            !item.countryCodes.includes(regionCode) && (
                              <span className="inline-flex items-center gap-1 w-fit rounded px-1.5 py-0.5 text-[11px] leading-none bg-amber-50 border border-amber-200 text-amber-700">
